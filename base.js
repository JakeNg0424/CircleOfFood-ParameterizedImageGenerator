...
/* global inspirations, initialize, render, mutate */
...
function setup() {
    ...
    currentDesign = initialize(currentInspiration);
...
function draw() {
    ...
    mutate(currentDesign, currentInspiration, slider.value / 100.0);
    randomSeed(0);
    render(currentDesign, currentInspiration);
